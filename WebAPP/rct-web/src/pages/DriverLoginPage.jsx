  ...
  return (
    <div className="inner-page">
      ...
      <div className="inner-form-card">
        ...
        <h2 className="inner-form-title">Welcome Back</h2>
        <p className="inner-form-sub">Sign in to your RCT driver account</p>
        ...
        <div className="forgot-link">
          <a className="link" onClick={() => onNavigate?.('forgot-password')}>Forgot Password?</a>
        </div>
        ...
        <p className="auth-footer" style={{ marginTop: '20px' }}>
          No account? <a onClick={() => onNavigate?.('registration')}>Sign up</a>
        </p>
      </div>
    </div>
  );
